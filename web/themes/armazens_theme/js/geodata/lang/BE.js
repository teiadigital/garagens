window.am5geodata_lang_BE = (function () {
// BELARUSIAN
const lang = {
    "AD": "Андора",
    ...
    "BN": "Бруней",
    "BO": "Балівія",
    "BQ": "Бонайре, Сінці-эстатиус i Саба",
    "BR": "Бразілія",
    "BS": "Багамы",
    "BT": "Бутан",
    "BV": "Востраў Бувэ",
    ...
    "MD": "Малдова",
    "ME": "Чарнагорыя",
    "MF": "Сahkt-Мартэн (Французская Частка)",
    "MG": "Мадагаскар",
    ...
    "SE": "Швецыя",
    "SG": "Сінгапур",
    "SH": "Астравы Святой Алены, Узнясення і Трыстан-да-Кунья",
    "SI": "Славенія",
    ...
    "SV": "Сальвадор",
    "SX": "Сінт-Мартэн (Галандская Частка)",
    "SY": "Сірыя",
    "SZ": "Свазіленд",
    "TC": "Цёркс і Кайкас",
    "TD": "Чад",
    "TF": "Французскія Паўднёвыя і Антарктычныя Тэрыторыі",
    "TG": "Тога",
    "TH": "Тайланд",
    "TJ": "Таджыкістан",
    "TK": "Такелаў",
    ...
    "TV": "Тувалу",
    "TW": "Кітайская Рэспубліка",
    "TZ": "Танзанія",
    "UA": "Украіна",
    "UG": "Уганда",
    "UM": "Вонкавыя малыя астравы ЗША",
    "US": "ЗША",
    "UY": "Уругвай",
    "UZ": "Узбекістан",
    "VA": "Ватыкан",
